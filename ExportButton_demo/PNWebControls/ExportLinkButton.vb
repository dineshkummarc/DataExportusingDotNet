...
Namespace PNayak.Web.UI.WebControls
    ...
    '@ <summary>An extended link button control to download data in Excel or CSV format
    '@ Drop this link button on ASP.NET page, set its Dataview property and when clicked it will
    '@ display a download dialog box for downloading CSV or XLS file.</summary>
    '@ <remarks><c>ExportLinkButton</c> extends standard ASP.NTE link Button control to implement 
    ...
    <DefaultProperty("ExportType"), ToolboxData("<{0}:ExportLinkButton runat=server></{0}:ExportLinkButton>")> _
    Public Class ExportLinkButton
...
#End Region
        ...
        '@ <example>[For Example: ExportLinkButton1.Dataview=Dataset.Tables(0).DefaultView]</example>
        <Bindable(False), Category("ExportLinkButton"), Browsable(False)> _
        ...
        <Bindable(False), Category("ExportLinkButton"), Description("File name to download."), Browsable(True)> _
        ...
        <Bindable(False), Category("ExportLinkButton"), Description("File format to export (Excel or CSV)."), Browsable(True), DefaultValue("CSV")> _
        ...
        '@ </summary>
        '@ <example>[For Example: SalesLedger.xls]</example>
        <Bindable(False), Category("ExportLinkButton"), Description("Usually Comma can be used for CSV and Tab for Excel.")> _
        ...
        '@ </summary>
        <Bindable(False), Category("ExportLinkButton"), Description("Single or Double quoted can be used to delimit data items.")> _
        ...
        '@ </summary>
        <Bindable(False), Category("ExportLinkButton"), Description("Used for various character sets. (Ex: 'iso-8859-2' used for Cenral Europian Characters)")> _
